...
def number_odd_or_even(n):
    """
    Displays an HTML page indicating if the number is odd or even.

    This function handles the /number_odd_or_even/<n> route and renders an HTML
    page with an H1 tag: “Number: n is even|odd” inside the BODY tag.
    """
